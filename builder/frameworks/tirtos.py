...
env.Append(
    ...
    CPPPATH=[
        ...
        join(FRAMEWORK_DIR, 'system/source/ti/devices/msp432e4/'),
    ...
    LIBS=[
        env.File(join(FRAMEWORK_DIR, "system/source/ti/devices/msp432e4/driverlib/gcc/msp432p4xx_driverlib.a")),
    ],
)